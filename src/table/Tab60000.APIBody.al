table 60000 "API Body"
{
    ...
    fields
    {
        ...
        field(4; "C02-SELLER_BRANCH_ID"; Text[250])
        {
            Caption = 'C02-SELLER_BRANCH_ID';
            DataClassification = ToBeClassified;
        }
        field(5; "C03-FILE_NAME"; Text[250])
        {
            Caption = 'C03-FILE_NAME';
            DataClassification = ToBeClassified;
        }
        field(6; "H01-DOCUMENT_TYPE_CODE"; Text[250])
        {
            Caption = 'H01-DOCUMENT_TYPE_CODE';
            DataClassification = ToBeClassified;
        }
        field(7; "H02-DOCUMENT_NAME"; Text[250])
        {
            Caption = 'H02-DOCUMENT_NAME';
            DataClassification = ToBeClassified;
        }
        field(8; "H03-DOCUMENT_ID"; Text[250])
        {
        ...
        field(10; "H05-CREATE_PURPOSE_CODE"; Text[250])
        {
            Caption = 'H05-CREATE_PURPOSE_CODE';
            DataClassification = ToBeClassified;
        }
        field(11; "H06-CREATE_PURPOSE"; Text[250])
        {
            Caption = 'H06-CREATE_PURPOSE';
            DataClassification = ToBeClassified;
        }
        field(12; "H07-ADDITIONAL_REF_ASSIGN_ID"; Text[250])
        {
        ...
        field(14; "H09-ADDITIONAL_REF_TYPE_CODE"; Text[250])
        {
            Caption = 'H09-ADDITIONAL_REF_TYPE_CODE';
            DataClassification = ToBeClassified;
        }
        field(15; "H10-ADDITIONAL_REF_DOCUMENT_NAME"; Text[250])
        {
            Caption = 'H10-ADDITIONAL_REF_DOCUMENT_NAME';
            DataClassification = ToBeClassified;
        }
        field(16; "H11-DELIVERY_TYPE_CODE"; Text[250])
        {
            Caption = 'H11-DELIVERY_TYPE_CODE';
            DataClassification = ToBeClassified;
        }
        field(17; "H12-BUYER_ORDER_ASSIGN_ID"; Text[250])
        {
        ...
        field(19; "H14-BUYER_ORDER_REF_TYPE_CODE"; Text[250])
        {
            Caption = 'H14-BUYER_ORDER_REF_TYPE_CODE';
            DataClassification = ToBeClassified;
        }
        field(20; "H15-DOCUMENT_REMARK"; Text[250])
        {
            Caption = 'H15-DOCUMENT_REMARK';
            DataClassification = ToBeClassified;
        }
        field(21; "H16-VOUCHER_NO"; Text[250])
        {
            Caption = 'H16-VOUCHER_NO';
            DataClassification = ToBeClassified;
        }
        field(22; "H17-SELLER_CONTACT_PERSON_NAME"; Text[250])
        {
            Caption = 'H17-SELLER_CONTACT_PERSON_NAME';
            DataClassification = ToBeClassified;
        }
        field(23; "H18-SELLER_CONTACT_DEPARTMENT_NAME"; Text[250])
        {
            Caption = 'H18-SELLER_CONTACT_DEPARTMENT_NAME';
            DataClassification = ToBeClassified;
        }
        field(24; "H19-SELLER_CONTACT_URIID"; Text[250])
        {
            Caption = 'H19-SELLER_CONTACT_URIID';
            DataClassification = ToBeClassified;
        }
        field(25; "H20-SELLER_CONTACT_PHONE_NO"; Text[250])
        {
            Caption = 'H20-SELLER_CONTACT_PHONE_NO';
            DataClassification = ToBeClassified;
        }
        field(26; "H21-FLEX_FIELD"; Text[250])
        {
            Caption = 'H21-FLEX_FIELD';
            DataClassification = ToBeClassified;
        }
        field(27; "H22-SELLER_BRANCH_ID"; Text[250])
        {
            Caption = 'H22-SELLER_BRANCH_ID';
            DataClassification = ToBeClassified;
        }
        field(28; "H23-SOURCE_SYSTEM"; Text[250])
        {
            Caption = 'H23-SOURCE_SYSTEM';
            DataClassification = ToBeClassified;
        }
        field(29; "H24-ENCRYPT_PASSWORD"; Text[250])
        {
            Caption = 'H24-ENCRYPT_PASSWORD';
            DataClassification = ToBeClassified;
        }
        field(30; "H25-PDF_TEMPLATE_ID"; Text[250])
        {
        ...
        field(33; "B01-BUYER_ID"; Text[250])
        {
            Caption = 'B01-BUYER_ID';
            DataClassification = ToBeClassified;
        }
        field(34; "B02-BUYER_NAME"; Text[250])
        {
            Caption = 'B02-BUYER_NAME';
            DataClassification = ToBeClassified;
        }
        field(35; "B03-BUYER_TAX_ID_TYPE"; Text[250])
        {
            Caption = 'B03-BUYER_TAX_ID_TYPE';
            DataClassification = ToBeClassified;
        }
        field(36; "B04-BUYER_TAX_ID"; Text[250])
        {
            Caption = 'B04-BUYER_TAX_ID';
            DataClassification = ToBeClassified;
        }
        field(37; "B05-BUYER_BRANCH_ID"; Text[250])
        {
            Caption = 'B05-BUYER_BRANCH_ID';
            DataClassification = ToBeClassified;
        }
        field(38; "B06-BUYER_CONTACT_PERSON_NAME"; Text[250])
        {
            Caption = 'B06-BUYER_CONTACT_PERSON_NAME';
            DataClassification = ToBeClassified;
        }
        field(39; "B07-BUYER_CONTACT_DEPARTMENT_NAME"; Text[250])
        {
            Caption = 'B07-BUYER_CONTACT_DEPARTMENT_NAME';
            DataClassification = ToBeClassified;
        }
        field(40; "B08-BUYER_URIID"; Text[250])
        {
            Caption = 'B08-BUYER_URIID';
            DataClassification = ToBeClassified;
        }
        field(41; "B09-BUYER_CONTACT_PHONE_NO"; Text[250])
        {
            Caption = 'B09-BUYER_CONTACT_PHONE_NO';
            DataClassification = ToBeClassified;
        }
        field(42; "B10-BUYER_POST_CODE"; Text[250])
        {
            Caption = 'B10-BUYER_POST_CODE';
            DataClassification = ToBeClassified;
        }
        field(43; "B11-BUYER_BUILDING_NAME"; Text[250])
        {
            Caption = 'B11-BUYER_BUILDING_NAME';
            DataClassification = ToBeClassified;
        }
        field(44; "B12-BUYER_BUILDING_NO"; Text[250])
        {
            Caption = 'B12-BUYER_BUILDING_NO';
            DataClassification = ToBeClassified;
        }
        field(45; "B13-BUYER_ADDRESS_LINE1"; Text[250])
        {
            Caption = 'B13-BUYER_ADDRESS_LINE1';
            DataClassification = ToBeClassified;
        }
        field(46; "B14-BUYER_ADDRESS_LINE2"; Text[250])
        {
            Caption = 'B14-BUYER_ADDRESS_LINE2';
            DataClassification = ToBeClassified;
        }
        field(47; "B15-BUYER_ADDRESS_LINE3"; Text[250])
        {
            Caption = 'B15-BUYER_ADDRESS_LINE3';
            DataClassification = ToBeClassified;
        }
        field(48; "B16-BUYER_ADDRESS_LINE4"; Text[250])
        {
            Caption = 'B16-BUYER_ADDRESS_LINE4';
            DataClassification = ToBeClassified;
        }
        field(49; "B17-BUYER_ADDRESS_LINE5"; Text[250])
        {
            Caption = 'B17-BUYER_ADDRESS_LINE5';
            DataClassification = ToBeClassified;
        }
        field(50; "B18-BUYER_STREET_NAME"; Text[250])
        {
            Caption = 'B18-BUYER_STREET_NAME';
            DataClassification = ToBeClassified;
        }
        field(51; "B19-BUYER_CITY_SUB_DIV_ID"; Text[250])
        {
            Caption = 'B19-BUYER_CITY_SUB_DIV_ID';
            DataClassification = ToBeClassified;
        }
        field(52; "B20-BUYER_CITY_SUB_DIV_NAME"; Text[250])
        {
            Caption = 'B20-BUYER_CITY_SUB_DIV_NAME';
            DataClassification = ToBeClassified;
        }
        field(53; "B21-BUYER_CITY_ID"; Text[250])
        {
            Caption = 'B21-BUYER_CITY_ID';
            DataClassification = ToBeClassified;
        }
        field(54; "B22-BUYER_CITY_NAME"; Text[250])
        {
            Caption = 'B22-BUYER_CITY_NAME';
            DataClassification = ToBeClassified;
        }
        field(55; "B23-BUYER_COUNTRY_SUB_DIV_ID"; Text[250])
        {
            Caption = 'B23-BUYER_COUNTRY_SUB_DIV_ID';
            DataClassification = ToBeClassified;
        }
        field(56; "B24-BUYER_COUNTRY_SUB_DIV_NAME"; Text[250])
        {
            Caption = 'B24-BUYER_COUNTRY_SUB_DIV_NAME';
            DataClassification = ToBeClassified;
        }
        field(57; "B25-BUYER_COUNTRY_ID"; Text[250])
        {
            Caption = 'B25-BUYER_COUNTRY_ID';
            DataClassification = ToBeClassified;
        }
        field(58; "O01-SHIP_TO_ID"; Text[250])
        {
            Caption = 'O01-SHIP_TO_ID';
            DataClassification = ToBeClassified;
        }
        field(59; "O02-SHIP_TO_NAME"; Text[250])
        {
            Caption = 'O02-SHIP_TO_NAME';
            DataClassification = ToBeClassified;
        }
        field(60; "O03-SHIP_TO_TAX_ID_TYPE"; Text[250])
        {
            Caption = 'O03-SHIP_TO_TAX_ID_TYPE';
            DataClassification = ToBeClassified;
        }
        field(61; "O04-SHIP_TO_TAX_ID"; Text[250])
        {
            Caption = 'O04-SHIP_TO_TAX_ID';
            DataClassification = ToBeClassified;
        }
        field(62; "O05-SHIP_TO_BRANCH_ID"; Text[250])
        {
            Caption = 'O05-SHIP_TO_BRANCH_ID';
            DataClassification = ToBeClassified;
        }
        field(63; "O06-SHIP_TO_CONTACT_PERSON_NAME"; Text[250])
        {
            Caption = 'O06-SHIP_TO_CONTACT_PERSON_NAME';
            DataClassification = ToBeClassified;
        }
        field(64; "O07-SHIP_TO_CONTACT_DEPARTMENT_NAME"; Text[250])
        {
            Caption = 'O07-SHIP_TO_CONTACT_DEPARTMENT_NAME';
            DataClassification = ToBeClassified;
        }
        field(65; "O08-SHIP_TO_URIID"; Text[250])
        {
            Caption = 'O08-SHIP_TO_URIID';
            DataClassification = ToBeClassified;
        }
        field(66; "O09-SHIP_TO_PHONE_NO"; Text[250])
        {
            Caption = 'O09-SHIP_TO_PHONE_NO';
            DataClassification = ToBeClassified;
        }
        field(67; "O10-SHIP_TO_POST_CODE"; Text[250])
        {
            Caption = 'O10-SHIP_TO_POST_CODE';
            DataClassification = ToBeClassified;
        }
        field(68; "O11-SHIP_TO_BUILDING_NAME"; Text[250])
        {
            Caption = 'O11-SHIP_TO_BUILDING_NAME';
            DataClassification = ToBeClassified;
        }
        field(69; "O12-SHIP_TO_BUILDING_NO"; Text[250])
        {
            Caption = 'O12-SHIP_TO_BUILDING_NO';
            DataClassification = ToBeClassified;
        }
        field(70; "O13-SHIP_TO_ADDRESS_LINE1"; Text[250])
        {
            Caption = 'O13-SHIP_TO_ADDRESS_LINE1';
            DataClassification = ToBeClassified;
        }
        field(71; "O14-SHIP_TO_ADDRESS_LINE2"; Text[250])
        {
            Caption = 'O14-SHIP_TO_ADDRESS_LINE2';
            DataClassification = ToBeClassified;
        }
        field(72; "O15-SHIP_TO_ADDRESS_LINE3"; Text[250])
        {
            Caption = 'O15-SHIP_TO_ADDRESS_LINE3';
            DataClassification = ToBeClassified;
        }
        field(73; "O16-SHIP_TO_ADDRESS_LINE4"; Text[250])
        {
            Caption = 'O16-SHIP_TO_ADDRESS_LINE4';
            DataClassification = ToBeClassified;
        }
        field(74; "O17-SHIP_TO_ADDRESS_LINE5"; Text[250])
        {
            Caption = 'O17-SHIP_TO_ADDRESS_LINE5';
            DataClassification = ToBeClassified;
        }
        field(75; "O18-SHIP_TO_STREET_NAME"; Text[250])
        {
            Caption = 'O18-SHIP_TO_STREET_NAME';
            DataClassification = ToBeClassified;
        }
        field(76; "O19-SHIP_TO_CITY_SUB_DIV_ID"; Text[250])
        {
            Caption = 'O19-SHIP_TO_CITY_SUB_DIV_ID';
            DataClassification = ToBeClassified;
        }
        field(77; "O20-SHIP_TO_CITY_SUB_DIV_NAME"; Text[250])
        {
            Caption = 'O20-SHIP_TO_CITY_SUB_DIV_NAME';
            DataClassification = ToBeClassified;
        }
        field(78; "O21-SHIP_TO_CITY_ID"; Text[250])
        {
            Caption = 'O21-SHIP_TO_CITY_ID';
            DataClassification = ToBeClassified;
        }
        field(79; "O22-SHIP_TO_CITY_NAME"; Text[250])
        {
            Caption = 'O22-SHIP_TO_CITY_NAME';
            DataClassification = ToBeClassified;
        }
        field(80; "O23-SHIP_TO_COUNTRY_SUB_DIV_ID"; Text[250])
        {
            Caption = 'O23-SHIP_TO_COUNTRY_SUB_DIV_ID';
            DataClassification = ToBeClassified;
        }
        field(81; "O24-SHIP_TO_COUNTRY_SUB_DIV_NAME"; Text[250])
        {
            Caption = 'O24-SHIP_TO_COUNTRY_SUB_DIV_NAME';
            DataClassification = ToBeClassified;
        }
        field(82; "O25-SHIP_TO_COUNTRY_ID"; Text[250])
        {
        ...
        field(84; "F01-LINE_TOTAL_COUNT"; Text[250])
        {
            Caption = 'F01-LINE_TOTAL_COUNT';
            DataClassification = ToBeClassified;
        }
        field(85; "F02-DELIVERY_OCCUR_DTM"; Text[250])
        {
            Caption = 'F02-DELIVERY_OCCUR_DTM';
            DataClassification = ToBeClassified;
        }
        field(86; "F03-INVOICE_CURRENCY_CODE"; Text[250])
        {
            Caption = 'F03-INVOICE_CURRENCY_CODE';
            DataClassification = ToBeClassified;
        }
        field(87; "F04-TAX_TYPE_CODE1"; Text[250])
        {
            Caption = 'F04-TAX_TYPE_CODE1';
            DataClassification = ToBeClassified;
        }
        field(88; "F05-TAX_CAL_RATE1"; Text[250])
        {
            Caption = 'F05-TAX_CAL_RATE1';
            DataClassification = ToBeClassified;
        }
        field(89; "F06-BASIS_AMOUNT1"; Text[250])
        {
            Caption = 'F06-BASIS_AMOUNT1';
            DataClassification = ToBeClassified;
        }
        field(90; "F07-BASIS_CURRENCY_CODE1"; Text[250])
        {
            Caption = 'F07-BASIS_CURRENCY_CODE1';
            DataClassification = ToBeClassified;
        }
        field(91; "F08-TAX_CAL_AMOUNT1"; Text[250])
        {
            Caption = 'F08-TAX_CAL_AMOUNT1';
            DataClassification = ToBeClassified;
        }
        field(92; "F09-TAX_CAL_CURRENCY_CODE1"; Text[250])
        {
            Caption = 'F09-TAX_CAL_CURRENCY_CODE1';
            DataClassification = ToBeClassified;
        }
        field(93; "F10-TAX_TYPE_CODE2"; Text[250])
        {
            Caption = 'F10-TAX_TYPE_CODE2';
            DataClassification = ToBeClassified;
        }
        field(94; "F11-TAX_CAL_RATE2"; Text[250])
        {
            Caption = 'F11-TAX_CAL_RATE2';
            DataClassification = ToBeClassified;
        }
        field(95; "F12-BASIS_AMOUNT2"; Text[250])
        {
            Caption = 'F12-BASIS_AMOUNT2';
            DataClassification = ToBeClassified;
        }
        field(96; "F13-BASIS_CURRENCY_CODE2"; Text[250])
        {
            Caption = 'F13-BASIS_CURRENCY_CODE2';
            DataClassification = ToBeClassified;
        }
        field(97; "F14-TAX_CAL_AMOUNT2"; Text[250])
        {
            Caption = 'F14-TAX_CAL_AMOUNT2';
            DataClassification = ToBeClassified;
        }
        field(98; "F15-TAX_CAL_CURRENCY_CODE2"; Text[250])
        {
            Caption = 'F15-TAX_CAL_CURRENCY_CODE2';
            DataClassification = ToBeClassified;
        }
        field(99; "F16-TAX_TYPE_CODE3"; Text[250])
        {
            Caption = 'F16-TAX_TYPE_CODE3';
            DataClassification = ToBeClassified;
        }
        field(100; "F17-TAX_CAL_RATE3"; Text[250])
        {
            Caption = 'F17-TAX_CAL_RATE3';
            DataClassification = ToBeClassified;
        }
        field(101; "F18-BASIS_AMOUNT3"; Text[250])
        {
            Caption = 'F18-BASIS_AMOUNT3';
            DataClassification = ToBeClassified;
        }
        field(102; "F19-BASIS_CURRENCY_CODE3"; Text[250])
        {
            Caption = 'F19-BASIS_CURRENCY_CODE3';
            DataClassification = ToBeClassified;
        }
        field(103; "F20-TAX_CAL_AMOUNT3"; Text[250])
        {
            Caption = 'F20-TAX_CAL_AMOUNT3';
            DataClassification = ToBeClassified;
        }
        field(104; "F21-TAX_CAL_CURRENCY_CODE3"; Text[250])
        {
            Caption = 'F21-TAX_CAL_CURRENCY_CODE3';
            DataClassification = ToBeClassified;
        }
        field(105; "F22-TAX_TYPE_CODE4"; Text[250])
        {
            Caption = 'F22-TAX_TYPE_CODE4';
            DataClassification = ToBeClassified;
        }
        field(106; "F23-TAX_CAL_RATE4"; Text[250])
        {
            Caption = 'F23-TAX_CAL_RATE4';
            DataClassification = ToBeClassified;
        }
        field(107; "F24-BASIS_AMOUNT4"; Text[250])
        {
            Caption = 'F24-BASIS_AMOUNT4';
            DataClassification = ToBeClassified;
        }
        field(108; "F25-BASIS_CURRENCY_CODE4"; Text[250])
        {
            Caption = 'F25-BASIS_CURRENCY_CODE4';
            DataClassification = ToBeClassified;
        }
        field(109; "F26-TAX_CAL_AMOUNT4"; Text[250])
        {
            Caption = 'F26-TAX_CAL_AMOUNT4';
            DataClassification = ToBeClassified;
        }
        field(110; "F27-TAX_CAL_CURRENCY_CODE4"; Text[250])
        {
            Caption = 'F27-TAX_CAL_CURRENCY_CODE4';
            DataClassification = ToBeClassified;
        }
        field(111; "F28-ALLOWANCE_CHARGE_IND"; Text[250])
        {
            Caption = 'F28-ALLOWANCE_CHARGE_IND';
            DataClassification = ToBeClassified;
        }
        field(112; "F29-ALLOWANCE_ACTUAL_AMOUNT"; Text[250])
        {
            Caption = 'F29-ALLOWANCE_ACTUAL_AMOUNT';
            DataClassification = ToBeClassified;
        }
        field(113; "F30-ALLOWANCE_ACTUAL_CURRENCY_CODE"; Text[250])
        {
